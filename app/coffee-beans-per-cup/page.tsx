...
export const metadata: Metadata = {
  title: "Coffee Beans per Cup Calculator – Whole Bean Count and Grams",
  description:
...
const faqs = [
  ...
  },
  {
    ...
    a: "A 12-cup coffee maker typically uses 12 x 148ml cups, totalling about 1,776ml of water. At a medium 1:16 ratio, that requires 111g of ground coffee – roughly 855 medium-roast Arabica beans. At a stronger 1:14 ratio, you need about 127g (978 beans). Select 12 cups and the Coffee Maker cup size in the calculator above to get the precise count for your strength preference.",
  },
  {
    q: "How do I measure whole coffee beans without a scale?",
    a: "The most reliable method without a scale is to count beans. For a single 250ml cup at medium strength, measure approximately 70 to 75 beans. For two cups, roughly 140 to 150 beans. Counting is more accurate than using a tablespoon or scoop for whole beans, because bean size varies by origin and roast. A scale is more practical for regular brewing – even an inexpensive kitchen scale gives consistent results.",
  },
  {
    q: "Are Robusta beans the same size as Arabica beans?",
    a: "No. Robusta beans are generally smaller than Arabica beans, weighing approximately 0.10g per bean compared to 0.13g for Arabica. This calculator is calibrated for Arabica coffee, which makes up the majority of specialty and commercial beans. If you are using Robusta or a blend, the bean count will be higher than shown – but the gram weight remains accurate regardless of bean type.",
  },
]
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        ...
        <div className="mt-6 mb-8">
          ...
          <p className="mt-3 text-base text-surface-600 dark:text-surface-300 leading-relaxed">
            ...
            roast level, cup size, and brew strength – with the gram weight and tablespoon equivalent
            after grinding.
          </p>
        </div>
        ...
        <article className="mt-12 space-y-6 text-surface-700 dark:text-surface-300 leading-relaxed text-[0.9375rem]">
          ...
          <p>
            ...
            needs 21g of coffee – about 162 beans for the same cup size. A light roast cup needs
          ...
          <p>
            ...
            process and retains more of the original bean mass – roughly 0.15g per bean. A dark
          ...
          <p>
            Counting beans is a useful reference for understanding scale – especially when you are
