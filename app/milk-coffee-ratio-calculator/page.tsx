...
const faqs = [
  {
    ...
    a: "A latte uses a 1:4 ratio of espresso to milk — approximately 60ml of espresso (double shot) and 240ml of steamed milk, totalling 300ml. The milk is mostly steamed liquid with a thin layer of microfoam on top, unlike a cappuccino which has a thick layer of foam. A latte is the most milk-forward of the standard espresso drinks.",
  },
  {
    q: "What makes a flat white different from a latte?",
    a: "A flat white uses a higher coffee-to-milk ratio than a latte (1:1.5 vs 1:4) and is served in a smaller cup (approximately 150ml total). It uses a double ristretto base rather than a double espresso, which contributes more sweetness and less bitterness. The milk texture is velvety microfoam throughout the drink rather than distinct foam on top — a flat white should have the consistency of warm cream from the first sip to the last.",
  },
  {
    q: "What is a cortado?",
    a: "A cortado is equal parts espresso and warm milk — a 1:1 ratio. A single shot (30ml) with 30ml of milk, or a double shot (60ml) with 60ml of milk. The word cortado comes from the Spanish for 'cut' — the milk cuts the acidity of the espresso without dominating the flavour. No foam is added. It is served in a small glass and consumed while the milk is still warm.",
  },
  {
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        ...
        <article className="mt-12 space-y-6 text-surface-700 dark:text-surface-300 leading-relaxed text-[0.9375rem]">
          ...
          <p>
            ...
            a reliable starting point for any of these drinks — use the Espresso Ratio Calculator
