...
export const metadata: Metadata = {
  title: "Iced Pour Over Calculator – Japanese Iced V60 Ratio and Recipe",
  description:
  ...
  openGraph: {
    ...
    description: "Japanese iced V60 ratio calculator. Get the exact hot water and ice amounts for any dose – no watery iced coffee.",
    type: "website",
  },
}
...
const faqs = [
  ...
  },
  {
    ...
    a: "The standard ratio for iced pour over is 1:15 total – the same total liquid as a normal pour over, split 60 percent hot water and 40 percent ice. For 20g of coffee: 180ml of hot water and 120g of ice (totalling 300ml). The hot water brews at a higher concentration than normal, and the ice dilutes and chills it simultaneously to achieve the final drinking strength.",
  },
  {
    q: "Why do you use 60% water and 40% ice?",
    a: "The 60/40 split is designed so that when the ice fully melts it equals the normal water volume for that dose. At a 1:15 ratio with 20g of coffee: normal water volume is 300ml total. Hot portion = 180ml (60%). Ice portion = 120g (40%) which melts to 120ml. Combined: 180 + 120 = 300ml – exactly a 1:15 cup at drinking strength and temperature. Using more ice produces a watered-down cup; less ice means the coffee is not fully chilled.",
  },
  {
  ...
  },
  {
    ...
    a: "Use the same water temperature as your regular pour over – 93 to 96C (200 to 205F) for light and medium roasts, 88 to 91C (190 to 195F) for dark roasts. The ice chilling happens after extraction, so temperature recommendations during brewing remain the same. Do not use cooler water thinking the ice will compensate – under-temperature water under-extracts and produces a sour, thin iced coffee.",
  },
]
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        ...
        <ShareBar title="Iced Coffee Pour Over Calculator – Coffee Brew Lab" url={`${process.env.NEXT_PUBLIC_APP_URL ?? "https://brewlab.coffee"}/iced-pour-over-calculator`} />
        ...
        <article className="mt-12 space-y-6 text-surface-700 dark:text-surface-300 leading-relaxed text-[0.9375rem]">
          ...
          <p>
            The key insight behind iced pour over is that the total liquid – hot water plus melted
            ice – should equal the volume you would normally use for that dose. At a 1:15 ratio
          ...
          <p>
            ...
            staling – volatile aromatic compounds degrade rapidly at high temperatures over time.
            This is why fridge-cooled drip coffee tastes flat compared to freshly brewed coffee.
          </p>
          <p>
            Flash chilling – dropping the temperature from 94C to near 0C in seconds – stops
