...
export const metadata: Metadata = {
  title: "Espresso Dial-In Calculator — Grind, Dose, Yield and Shot Time Adjustments",
  description:
    "Dial in your espresso shot with specific adjustments. Enter your dose, yield, shot time, and taste verdict to get a precise fix — grind finer, reduce yield, adjust dose. No vague advice.",
  ...
  openGraph: {
    ...
    description: "Enter your shot data and taste verdict to get a specific adjustment. Grind finer, pull more yield, or change dose — not vague advice.",
    type: "website",
  },
}
...
const faqs = [
  {
    ...
    a: "Dialling in espresso means adjusting the three main variables — grind size, dose (coffee weight in the basket), and yield (liquid espresso in the cup) — until the shot tastes balanced. The standard target is a 1:2 ratio (18g dose to 36g yield) in 25-35 seconds. Most baristas fix shot time with grind size first, then fix taste by adjusting yield or dose. The process is iterative: pull a shot, taste it, make one change, pull again.",
  },
  {
    q: "Why does my espresso taste sour?",
    a: "Sourness in espresso means under-extraction — the water did not extract enough of the soluble compounds from the grounds. The most common cause is a shot that ran too fast (grind too coarse) or a yield that is too short (not enough liquid pulled through). If your shot time is under 25 seconds, grind finer. If your shot time is in the normal range (25-35s) but the taste is still sour, try pulling more yield — increase the liquid weight by 5g and taste again.",
  },
  {
    q: "Why does my espresso taste bitter?",
    a: "Bitterness in espresso means over-extraction — too many compounds were extracted from the grounds. The most common cause is a shot that ran too slow (grind too fine) or a yield that is too long (too much liquid pulled through). If your shot time is over 35 seconds, grind coarser. If shot time is normal but the taste is still bitter, try reducing yield by 5g — stop the shot earlier than usual and taste the result.",
  },
  {
    q: "What is the ideal espresso shot time?",
    a: "The target shot time for most espresso is 25-35 seconds, measured from the moment water first contacts the puck. A ristretto (1:1 ratio) typically runs 20-30 seconds. A lungo (1:3 ratio) typically runs 35-45 seconds. Shot time is controlled by grind size — finer grind slows the shot, coarser grind speeds it up. Dose weight also affects shot time slightly: more coffee in the basket slows the flow.",
  },
  {
  ...
  },
  {
    ...
    a: "The standard dose for a double espresso basket is 18-20g of ground coffee. Most modern baskets are designed for this range. Some larger baskets accept 20-22g. The dose should fill the basket evenly without mounding or underfilling — the basket size is a physical constraint that limits your dose range. Do not try to use 15g in an 18g basket or 22g in a 20g basket: puck preparation problems will result.",
  },
  {
  ...
  },
  {
    ...
    a: "Weak or thin espresso usually means the ratio is too high (too much liquid for the amount of coffee used) or the dose is too low for your basket. If your yield-to-dose ratio is above 1:2.5, try pulling the shot shorter — stop at a lower yield weight. If the ratio is correct but the shot still tastes thin, increase your dose by 1-2g. A larger dose produces a more concentrated, full-bodied shot.",
  },
]
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        ...
        <div className="mt-6 mb-8">
          ...
          <p className="mt-3 text-base text-surface-600 dark:text-surface-300 leading-relaxed">
            ...
            pull a different yield, or change your dose — with exact numbers, not vague advice.
          </p>
        </div>
        ...
        <article className="mt-12 space-y-6 text-surface-700 dark:text-surface-300 leading-relaxed text-[0.9375rem]">
          ...
          <p>
            ...
            the grind is too coarse — regardless of taste. A shot over 45 seconds tells you the grind
          ...
          <p>
            ...
            and lighter — useful for reducing bitterness or adding clarity. Reducing yield makes the
            shot shorter and more concentrated — useful for adding sweetness and body when the shot
            is sour or thin.
          </p>
          <p>
          ...
          <p>
            ...
            Most home baristas should not adjust dose frequently — the basket size constrains the
