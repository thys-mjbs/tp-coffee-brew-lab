...
export const metadata: Metadata = {
  title: "Espresso Ratio Calculator – Dose and Yield for Espresso, Ristretto, and Lungo",
  description:
...
const faqs = [
  {
    ...
    a: "The standard espresso ratio is 1:2 – 1g of ground coffee in (dose) to 2g of liquid espresso out (yield). For an 18g dose, the target yield is 36g. This ratio produces the balanced extraction that defines classic espresso: concentrated, syrupy, with a thin layer of crema. The 1:2 ratio is the starting point for most specialty espresso bars worldwide.",
  },
  {
    q: "What is the difference between a ristretto and an espresso?",
    a: "A ristretto uses a 1:1 ratio – the yield equals the dose weight. An 18g dose produces 18g of yield (approximately 18ml). Because less water passes through the grounds, a ristretto extracts the most soluble, sweetest compounds first and stops before the more bitter, astringent compounds extract. The result is a shorter, sweeter, more intense shot. Flat whites are often made with a double ristretto base.",
  },
  {
    q: "What is a lungo and how does its ratio differ?",
    a: "A lungo uses a 1:3 ratio – three times the dose weight in yield. An 18g dose produces 54g of yield. More water passes through the puck, extracting more compounds including some that contribute bitterness and higher caffeine. A lungo is not simply a diluted espresso – it is a distinct extraction with a different flavour profile: lighter, more bitter, and higher caffeine per serving than a standard shot.",
  },
  {
    q: "How do I measure espresso yield?",
    a: "Place a small scale under your portafilter or cup before pulling the shot. Zero the scale, start the shot, and watch the weight climb. Stop the pump when the scale reads your target yield – for an 18g dose at 1:2, that is 36g. This is more accurate than measuring by volume because crema density varies and distorts volume readings. Most espresso scales have a timer built in so you can track shot time simultaneously.",
  },
  {
    q: "What dose should I use for a double espresso?",
    a: "Most double basket portafilters hold 18 to 20g of ground coffee, which is the standard range for a double shot. Some larger baskets support up to 22g for a more concentrated result. Single shot baskets typically hold 7 to 9g. The dose you use should fill the basket evenly without mounding or underfilling – the basket size is your physical constraint, and the ratio determines your yield target from that dose.",
  },
  {
    q: "Should espresso yield be measured in grams or millilitres?",
    a: "Grams is the correct unit for espresso yield. Espresso has varying crema density – 1ml of espresso does not consistently equal 1g because crema is mostly air. Measuring in grams on a scale gives consistent, repeatable results. For practical purposes, 1g of liquid espresso is approximately 1ml of the liquid portion, so conversions are close but not exact.",
  },
  {
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        ...
        <ShareBar title="Espresso Ratio Calculator – Coffee Brew Lab" url={`${process.env.NEXT_PUBLIC_APP_URL ?? "https://brewlab.coffee"}/espresso-ratio-calculator`} />
        ...
        <article className="mt-12 space-y-6 text-surface-700 dark:text-surface-300 leading-relaxed text-[0.9375rem]">
          ...
          <p>
            The ratio does not tell you how long the shot takes – that is controlled by grind
