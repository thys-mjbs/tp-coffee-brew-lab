...
export const metadata: Metadata = {
  title: "AeroPress Brew Timer – Step-by-Step Countdown for Every Method",
  description:
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        ...
        <div className="mt-6 mb-8">
          ...
          <p className="mt-3 text-base text-surface-600 dark:text-surface-300 leading-relaxed">
            Select your method – standard, inverted, or James Hoffmann – and let the timer guide
        ...
        <ShareBar title="AeroPress Brew Timer – Coffee Brew Lab" url={`${process.env.NEXT_PUBLIC_APP_URL ?? "https://brewlab.coffee"}/aeropress-timer`} />
        ...
        <article className="mt-12 space-y-6 text-surface-700 dark:text-surface-300 leading-relaxed text-[0.9375rem]">
          ...
          <p>
            ...
            The total brew time – from first pour to pressing – controls how much is extracted
          ...
          <p>
            ...
            at each moment. The stage transitions happen automatically – you do not need to watch
          ...
          <p>
            ...
            is the second variable to adjust – finer for more extraction, coarser for less – but
