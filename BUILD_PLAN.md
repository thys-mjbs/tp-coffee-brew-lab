...
[ ] Phase 1: Project Setup & Foundation
    [ ] Milestone 1.1: Initialize project, design system, and data layer
    [ ] Milestone 1.2: Build shared layout (header, footer, navigation, breadcrumb)
    [ ] Milestone 1.3: Build static pages (About, Privacy, Terms, Contact, 404)
    [ ] Milestone 1.4: Build homepage with tool grid
